...
export default function AdminFoodsPage() {
  ...
  const queryParams = { page, limit: 15, search, ...(filter !== '' && { isAvailable: filter }) };
  const { data, isLoading } = useGetAdminFoodsQuery(queryParams);
  ...
  return (
    <div className="space-y-6">
      <h1 className="font-heading font-bold text-2xl text-gray-900 dark:text-white">Food Items Management</h1>
